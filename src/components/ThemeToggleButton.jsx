...
function ThemeToggleButton() {
    ...
    const position = theme === 'light' ? 'justify-start' : theme === 'dark' ? 'justify-center' : 'justify-end'
    ...
    return (
        <div className="w-[4.25rem] flex flex-col gap-2">
            ...
            <div className={`w-full h-[1.625rem] bg-gray-300 rounded-[0.8125rem] p-[0.3125rem] flex ${position}`} data-toggle-container onClick={handleToggleEvent}>
